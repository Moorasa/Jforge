...
<head>
    ...
    <link rel="stylesheet" href="${ctx}/css/admin/common/schemaForm.css?v=20260807-2" />
    <link rel="stylesheet" href="${ctx}/css/admin/studio/studio.css?v=20260807-2" />
    ...
    <script defer src="${ctx}/js/admin/catalog/schemaFormRenderer.js?v=20260807-2"></script>
    <script defer src="${ctx}/js/admin/studio/propsPanel.js?v=20260807-2"></script>
    ...
    <script defer src="${ctx}/js/admin/studio/screenPicker.js?v=20260807-2"></script>
    ...
    <script defer src="${ctx}/js/admin/studio/previewBridge.js?v=20260807-2"></script>
    ...
    <script defer src="${ctx}/js/admin/studio/layerPanel.js?v=20260807-2"></script>
</head>
