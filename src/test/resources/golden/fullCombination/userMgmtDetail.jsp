    ...
    <section id="basic-info" class="view-mode basic-compact">
        ...
        <div class="detail-info-view">
            <div class="layout-column">
                ...
                <div class="detail-field" data-name="email">
        ...
        <div class="detail-info-edit">
            <div class="layout-column">
                ...
                <div class="edit-field" data-name="email">
                    <label class="clearable" for="bi-email">이메일</label>
                    <input type="email" id="bi-email" name="email" class="detail-input" />
                </div>
            </div>
        </div>
        <div class="buttons">
