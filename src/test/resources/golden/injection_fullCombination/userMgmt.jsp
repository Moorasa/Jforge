...
<div id="userMgmt-shell" class="page-shell with-detail" data-stem="userMgmt" data-archetype="MGMT_LIST_DETAIL" data-role="admin">
    <jsp:include page="./userMgmtList.jsp" />
    <jsp:include page="./userMgmtDetail.jsp" />
</div>
