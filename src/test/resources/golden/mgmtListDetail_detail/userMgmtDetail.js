window.MagicIAM_JSUserMgmtAdminDetail = window.MagicIAM_JSUserMgmtAdminDetail || {};
(function(detail) {
	"use strict";
	...
	var associateTabs = [
		{ tabClass: "tab-role", frameId: "roleFrame", location: "" /* TODO(배선): 연관 화면 URL */ },
		{ tabClass: "tab-history", frameId: "historyFrame", location: "" /* TODO(배선): 연관 화면 URL */ }
	];
...
})(window.MagicIAM_JSUserMgmtAdminDetail);
